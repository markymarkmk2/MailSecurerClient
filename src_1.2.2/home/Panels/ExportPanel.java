 ...
 * @author mw
 */
public class ExportPanel extends GlossDialogPanel implements ActionListener
{
...
//             if (status != last_status)
             ...
             if (status != STATUS.NOT_STARTED)
             {
                 ...
                 TXT_PATH.setText( pt.GetString("PTH:"));
    ...
    private String evalPath() {
        ...
        GlossFileChooser gfc = new GlossFileChooser(fsv, lastPath, null, true);
        GenericGlossyDlg dlg = new GenericGlossyDlg(UserMain.self, true, gfc);
        dlg.setVisible(true);
        if (gfc.get_act_file() != null)
        {
            lastPath = gfc.get_act_file().getAbsolutePath();
            return lastPath;
        } 
        return null;
    }
    ...
    private void initComponents() {
        ...
        jLabel10.setText(UserMain.Txt("Exportpath")); // NOI18N
