...
//    Radar radar;
    ...
    public GlossErrDialog(java.awt.Frame parent)
    {
        ...
        busy_comp = new YingYang();
//        busy_comp.setSize( PN_ICON.getSize());
//        radar = new Radar();
        set_defaults();
    }
...
//        radar = new Radar();
    ...
    private void set_defaults()
    {
        if (Main.ui.has_rendered_panels())
        {
            ...
            this.TXT_ERR.setForeground(Main.ui.get_foreground());
        }
...
/*
    ...
    private void initComponents() {
        ...
        PN_ERRLayout.setHorizontalGroup(
            ...
            .addGroup(PN_ERRLayout.createSequentialGroup()
                ...
                .addGroup(PN_ERRLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(PN_ERRLayout.createSequentialGroup()
                        .addComponent(PN_ICON, javax.swing.GroupLayout.PREFERRED_SIZE, 90, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        PN_ERRLayout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {BT_ABORT, BT_OK});
        ...
        PN_ERRLayout.setVerticalGroup(
            ...
            .addGroup(PN_ERRLayout.createSequentialGroup()
                ...
                .addGroup(PN_ERRLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(PN_ICON, javax.swing.GroupLayout.PREFERRED_SIZE, 90, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(TXT_ERR, javax.swing.GroupLayout.DEFAULT_SIZE, 112, Short.MAX_VALUE))
