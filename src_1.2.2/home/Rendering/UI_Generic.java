...
public abstract class UI_Generic
{
    ...
    public abstract Color get_background();
    public abstract Color get_foreground();
    public abstract Color get_nice_gray();
    public abstract Font get_small_font();
    public abstract void set_ui(boolean verbose);

    public abstract boolean has_rendered_button();
    public abstract boolean has_rendered_panels();
    ...
    public static void save_uid()
    {
        ...
        uid_save = new TreeMap<Object,Object>(  );
    ...
    public static void restore_uid()
    {
        if (uid_save == null)
            return;
        ...
        NavigableSet ks = uid_save.navigableKeySet();
        Iterator i = ks.iterator();
        while (i.hasNext())
        {
            Object key = i.next();
            Object val = uid_save.get(key);
