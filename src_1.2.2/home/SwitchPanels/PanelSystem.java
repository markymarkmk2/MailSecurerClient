...
import dimm.home.Panels.UpdatePanel;
...
public class PanelSystem extends SwitchSpringPanel
{
    ...
    private void initComponents() {
        ...
        PN_BUTTONS.add(BT_ZERTIFIKATE, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 200, 150, 50));

        BT_AUDITLOG.setFont(new java.awt.Font("Arial", 0, 14));
        ...
        BT_CONFIG_LOG.setFont(new java.awt.Font("Arial", 0, 14));
        ...
        BT_UPDATES.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        BT_UPDATES.setForeground(new java.awt.Color(201, 201, 201));
        BT_UPDATES.setIcon(new javax.swing.ImageIcon(getClass().getResource("/dimm/home/images/Earth-Download-icon.png"))); // NOI18N
        BT_UPDATES.setText(UserMain.Txt("Updates")); // NOI18N
        BT_UPDATES.setToolTipText(UserMain.getString("Look_for_Updates")); // NOI18N
        BT_UPDATES.setBorderPainted(false);
        BT_UPDATES.setContentAreaFilled(false);
        BT_UPDATES.setFocusPainted(false);
        BT_UPDATES.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BT_UPDATES.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BT_UPDATESActionPerformed(evt);
            }
        });
        PN_BUTTONS.add(BT_UPDATES, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 200, 150, 50));
    ...
    private void BT_UPDATESActionPerformed(java.awt.event.ActionEvent evt)//GEN-FIRST:event_BT_UPDATESActionPerformed
    {//GEN-HEADEREND:event_BT_UPDATESActionPerformed
        // TODO add your handling code here:
        TimingTargetAdapter tt = make_spring_button_dlg( new UpdatePanel(),  get_dlg_pos(),  UserMain.getString("Updates") );
        spring_button_action(evt.getSource(), tt);

    }//GEN-LAST:event_BT_UPDATESActionPerformed
    ...
    private javax.swing.JButton BT_UPDATES;
